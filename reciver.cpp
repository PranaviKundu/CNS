...
// Function to detect error position in the 12-bit hamming codeword
...
// Function to correct the bit at error_pos (1-based indexing)
...
// Extract the original data bits from the codeword (skip parity bits)
...
int main() {
    ...
    // Extract original data bits and decode character
